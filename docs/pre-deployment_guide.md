...
Refer to the [Deployment section of the main README]([https://github.com/markaolson/google-cloud-daos/tree/DAOSGCP-119#deployment](https://github.com/daos-stack/google-cloud-daos#deployment)) for information on how to deploy DAOS on GCP.
